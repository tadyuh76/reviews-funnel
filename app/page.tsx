...
export default function Home() {
  return (
    <main className="flex justify-center items-center h-screen bg-[url('/background-pattern.png')] bg-repeat">
      <div className="bg-[var(--foreground-color)] p-10 rounded-2xl flex flex-col items-center w-1/2">
        ...
        <div className="flex justify-center space-x-10">
          <div className="w-60 h-60 border-2 border-[var(--light-grey)] hover:border-[var(--foreground)] rounded-3xl flex-col flex items-center justify-center mb-2">
            <BadEmojiSVG />
