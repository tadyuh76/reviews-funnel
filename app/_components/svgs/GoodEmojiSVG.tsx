...
const GoodEmojiSVG = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={144} height={144} fill="none" {...props}>
    ...
    >
      <path
        fill="#2F3B4A"
        d="M72 60.035c-14.117.26-26.547-6.001-29.496 3C39.554 72.035 49.583 85 72 85c22.417 0 32.446-12.965 29.496-21.965-2.95-9-16.504-3.239-29.496-3Z"
      />
    </mask>
    <g mask="url(#a)">
      <path
      ...
      <path
        fill="#F7F8FA"
        d="M168-29c0 53.02-42.981 96-96 96-53.02 0-96-42.98-96-96s42.98-96 96-96c53.019 0 96 42.98 96 96Z"
      />
    </g>
  </svg>
)
